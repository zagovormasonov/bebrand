...
"Здравствуйте, меня зовут Алексей Баженов, я руководитель удмуртского филиала компании BeBrand в Ижевске." + попытаться узнать имя
...
Сообщение от клиента: "Для чего вообще регистрировать?"
