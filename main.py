...
ОБЯЗАТЕЛЬНО сделай чтобы ответ от api чата гпт был разделен на абзацы или точками, в общем чтобы было какое то форматирование 

НЕ НАДО! повторять за пользователем то, что он только что написал.
